...
public class ScoreFront extends Application {
    ...
    /**
     * Sorts list of GameSessions based on score, numbers x,  0 <= x. Top Scores on high index, low scores on low index.
     ...
     * @param gameType accessed from a verified String factory where one String only corresponds to a legal game type in database.
     ...
     * @return array where indexes of content userIDs matches indexes of corresponding input gameIDs,
     * as in owners indexed as gameIDs.
     */
